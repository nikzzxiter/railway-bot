...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    keyboard = [
        [InlineKeyboardButton("Analyze APK", callback_data="analyze_apk")],
        [InlineKeyboardButton("Encrypt File", callback_data="encrypt_file")],
        [InlineKeyboardButton("Decrypt File", callback_data="decrypt_file")],
        [InlineKeyboardButton("Obfuscate Strings", callback_data="obfuscate_strings")],
        [InlineKeyboardButton("Protect DEX", callback_data="protect_dex")],
        [InlineKeyboardButton("Protect Assets", callback_data="protect_assets")]
    ]
    reply_markup = InlineKeyboardMarkup(keyboard)
    await update.message.reply_text("Select a feature to use:", reply_markup=reply_markup)
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if feature == "analyze_apk":
        await query.edit_message_text("Send the APK file to analyze.")
    elif feature == "encrypt_file":
        await query.edit_message_text("Send the file you want to encrypt.")
    elif feature == "decrypt_file":
        await query.edit_message_text("Send the file you want to decrypt.")
    elif feature == "obfuscate_strings":
        await query.edit_message_text("Send source code text to obfuscate strings.")
    elif feature == "protect_dex":
        await query.edit_message_text("Send DEX file to protect.")
    elif feature == "protect_assets":
        await query.edit_message_text("Send the asset directory to protect.")
    else:
        await query.edit_message_text("Feature not recognized.")
...
def run_bot():
    ...
    print("Bot started... Waiting for interactions.")
